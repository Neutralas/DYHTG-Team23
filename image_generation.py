...
class ImageGen():
        ...
        for i in range(5):
            ...
            while not valid:
                ...
                try:
                    ...
                    print(e)
        # self.reduce_dir()
        self.set_block_imgs(['stone.png','granite.png','diorite.png','andesite.png','deepsplate.png'])
        self.copy_folder()
    ...
    def generate(self, prompt, output_size = 1):
        for i in range(output_size):
            self.generate_img(prompt, i)

    def generate_img(self, prompt, num):
        img_file = os.getcwd() + '\\new_images'
        client = replicate.Client(api_token="4952cc51f624a8ef2494f6257b8e78fc9130b4db")
    ...
    def set_block_imgs(self, block_names, img_folder='new_images'):
    ...
    def copy_folder(self):
        copy_tree("scary_pack/assets/minecraft/textures/block",
                  "C:/Users/jonai/AppData/Roaming/.minecraft/resourcepacks/scary_pack/assets/minecraft/textures/block")
